...
/**
 * REST controller for managing {@link com.lgs.domain.Client}.
 */
@RestController
@RequestMapping("/api")
public class ClientResource {
    ...
    @GetMapping("/clients/clientsAndAgences")
    public ResponseEntity<List<ClientAndListAgenceDTO>> clientAndListAgences()
    {
        return ResponseEntity.ok().body(clientService.clientAndListAgences());
    }

    @GetMapping("/clients/agencesClient/{id}")
    public ResponseEntity<List<AgenceDTO>> agencesClient(@PathVariable Long id)
    {
        return ResponseEntity.ok().body(clientService.findAgenceByClientId(id));
    }
}
